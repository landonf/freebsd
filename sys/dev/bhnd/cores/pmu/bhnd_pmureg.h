...
#define	BHND_PMU_RES_STATE		0x0c
#define	BHND_PMU_RES_PENDING		0x10
#define	BHND_PMU_TIMER			0x14
#define	BHND_PMU_MIN_RES_MASK		0x18
#define	BHND_PMU_MAX_RES_MASK		0x1c
...
#define	BHND_PMU_WATCHDOG		0x34
#define	BHND_PMU_GPIOSEL		0x38		/* pmu rev >= 1 ? */
#define	BHND_PMU_GPIOEN			0x3C		/* pmu rev >= 1 ? */
#define	BHND_PMU_RES_REQ_TIMER_SEL	0x40
#define	BHND_PMU_RES_REQ_TIMER		0x44
...
#define	BHND_PMU_RES_REQ_MASK		0x48
#define	BHND_PMU_CHIPCTL_ADDR		0x50
#define	BHND_PMU_CHIPCTL_DATA		0x54
#define	BHND_PMU_REG_CONTROL_ADDR	0x58
#define	BHND_PMU_REG_CONTROL_DATA	0x5C
#define	BHND_PMU_PLL_CONTROL_ADDR 	0x60
#define	BHND_PMU_PLL_CONTROL_DATA 	0x64
#define	BHND_PMU_STRAPOPT		0x68		/* chipc rev >= 28 */
...
#define	BHND_PMU_PMU0_PLL0_PLLCTL0		0
#define	BHND_PMU_PMU0_PLL0_PC0_PDIV_MASK	1
#define	BHND_PMU_PMU0_PLL0_PC0_PDIV_FREQ	25000
#define	BHND_PMU_PMU0_PLL0_PC0_DIV_ARM_MASK	0x00000038
#define	BHND_PMU_PMU0_PLL0_PC0_DIV_ARM_SHIFT	3
#define	BHND_PMU_PMU0_PLL0_PC0_DIV_ARM_BASE	8

/* PC0_DIV_ARM for PLLOUT_ARM */
#define	BHND_PMU_PMU0_PLL0_PC0_DIV_ARM_110MHZ	0
#define	BHND_PMU_PMU0_PLL0_PC0_DIV_ARM_97_7MHZ	1
#define	BHND_PMU_PMU0_PLL0_PC0_DIV_ARM_88MHZ	2
#define	BHND_PMU_PMU0_PLL0_PC0_DIV_ARM_80MHZ	3	/* Default */
#define	BHND_PMU_PMU0_PLL0_PC0_DIV_ARM_73_3MHZ	4
#define	BHND_PMU_PMU0_PLL0_PC0_DIV_ARM_67_7MHZ	5
#define	BHND_PMU_PMU0_PLL0_PC0_DIV_ARM_62_9MHZ	6
#define	BHND_PMU_PMU0_PLL0_PC0_DIV_ARM_58_6MHZ	7

/* Wildcard base, stop_mod, en_lf_tp, en_cal & lf_r2 */
#define	BHND_PMU_PMU0_PLL0_PLLCTL1		1
#define	BHND_PMU_PMU0_PLL0_PC1_WILD_INT_MASK	0xf0000000
#define	BHND_PMU_PMU0_PLL0_PC1_WILD_INT_SHIFT	28
#define	BHND_PMU_PMU0_PLL0_PC1_WILD_FRAC_MASK	0x0fffff00
#define	BHND_PMU_PMU0_PLL0_PC1_WILD_FRAC_SHIFT	8
#define	BHND_PMU_PMU0_PLL0_PC1_STOP_MOD		0x00000040

/* Wildcard base, vco_calvar, vco_swc, vco_var_selref, vso_ical & vco_sel_avdd */
#define	BHND_PMU_PMU0_PLL0_PLLCTL2		2
#define	BHND_PMU_PMU0_PLL0_PC2_WILD_INT_MASK	0xf
#define	BHND_PMU_PMU0_PLL0_PC2_WILD_INT_SHIFT	4

/* pllcontrol registers */
/* ndiv_pwrdn, pwrdn_ch<x>, refcomp_pwrdn, dly_ch<x>, p1div, p2div, _bypass_sdmod */
#define	BHND_PMU_PMU1_PLL0_PLLCTL0		0
#define	BHND_PMU_PMU1_PLL0_PC0_P1DIV_MASK	0x00f00000
#define	BHND_PMU_PMU1_PLL0_PC0_P1DIV_SHIFT	20
#define	BHND_PMU_PMU1_PLL0_PC0_P2DIV_MASK	0x0f000000
#define	BHND_PMU_PMU1_PLL0_PC0_P2DIV_SHIFT	24

/* m<x>div */
#define	BHND_PMU_PMU1_PLL0_PLLCTL1		1
#define	BHND_PMU_PMU1_PLL0_PC1_M1DIV_MASK	0x000000ff
#define	BHND_PMU_PMU1_PLL0_PC1_M1DIV_SHIFT	0
#define	BHND_PMU_PMU1_PLL0_PC1_M2DIV_MASK	0x0000ff00
#define	BHND_PMU_PMU1_PLL0_PC1_M2DIV_SHIFT	8
#define	BHND_PMU_PMU1_PLL0_PC1_M3DIV_MASK	0x00ff0000
#define	BHND_PMU_PMU1_PLL0_PC1_M3DIV_SHIFT	16
#define	BHND_PMU_PMU1_PLL0_PC1_M4DIV_MASK	0xff000000
#define	BHND_PMU_PMU1_PLL0_PC1_M4DIV_SHIFT	24

#define	BHND_PMU_DOT11MAC_880MHZ_CLK_DIVISOR_SHIFT 8
#define	BHND_PMU_DOT11MAC_880MHZ_CLK_DIVISOR_MASK (0xFF << DOT11MAC_880MHZ_CLK_DIVISOR_SHIFT)
#define	BHND_PMU_DOT11MAC_880MHZ_CLK_DIVISOR_VAL  (0xE << DOT11MAC_880MHZ_CLK_DIVISOR_SHIFT)

/* m<x>div, ndiv_dither_mfb, ndiv_mode, ndiv_int */
#define	BHND_PMU_PMU1_PLL0_PLLCTL2		2
#define	BHND_PMU_PMU1_PLL0_PC2_M5DIV_MASK	0x000000ff
#define	BHND_PMU_PMU1_PLL0_PC2_M5DIV_SHIFT	0
#define	BHND_PMU_PMU1_PLL0_PC2_M6DIV_MASK	0x0000ff00
#define	BHND_PMU_PMU1_PLL0_PC2_M6DIV_SHIFT	8
#define	BHND_PMU_PMU1_PLL0_PC2_NDIV_MODE_MASK	0x000e0000
#define	BHND_PMU_PMU1_PLL0_PC2_NDIV_MODE_SHIFT	17
#define	BHND_PMU_PMU1_PLL0_PC2_NDIV_MODE_MASH	1
#define	BHND_PMU_PMU1_PLL0_PC2_NDIV_MODE_MFB	2	/* recommended for 4319 */
#define	BHND_PMU_PMU1_PLL0_PC2_NDIV_INT_MASK	0x1ff00000
#define	BHND_PMU_PMU1_PLL0_PC2_NDIV_INT_SHIFT	20

/* ndiv_frac */
#define	BHND_PMU_PMU1_PLL0_PLLCTL3		3
#define	BHND_PMU_PMU1_PLL0_PC3_NDIV_FRAC_MASK	0x00ffffff
#define	BHND_PMU_PMU1_PLL0_PC3_NDIV_FRAC_SHIFT	0

/* pll_ctrl */
#define	BHND_PMU_PMU1_PLL0_PLLCTL4		4

/* pll_ctrl, vco_rng, clkdrive_ch<x> */
#define	BHND_PMU_PMU1_PLL0_PLLCTL5		5
#define	BHND_PMU_PMU1_PLL0_PC5_CLK_DRV_MASK	0xffffff00
#define	BHND_PMU_PMU1_PLL0_PC5_CLK_DRV_SHIFT	8

/* PMU rev 2 control words */
#define	BHND_PMU_PMU2_PHY_PLL_PLLCTL		4
#define	BHND_PMU_PMU2_SI_PLL_PLLCTL		10

/* PMU rev 2 */
/* pllcontrol registers */
/* ndiv_pwrdn, pwrdn_ch<x>, refcomp_pwrdn, dly_ch<x>, p1div, p2div, _bypass_sdmod */
#define	BHND_PMU_PMU2_PLL_PLLCTL0		0
#define	BHND_PMU_PMU2_PLL_PC0_P1DIV_MASK 	0x00f00000
#define	BHND_PMU_PMU2_PLL_PC0_P1DIV_SHIFT	20
#define	BHND_PMU_PMU2_PLL_PC0_P2DIV_MASK 	0x0f000000
#define	BHND_PMU_PMU2_PLL_PC0_P2DIV_SHIFT	24

/* m<x>div */
#define	BHND_PMU_PMU2_PLL_PLLCTL1		1
#define	BHND_PMU_PMU2_PLL_PC1_M1DIV_MASK 	0x000000ff
#define	BHND_PMU_PMU2_PLL_PC1_M1DIV_SHIFT	0
#define	BHND_PMU_PMU2_PLL_PC1_M2DIV_MASK 	0x0000ff00
#define	BHND_PMU_PMU2_PLL_PC1_M2DIV_SHIFT	8
#define	BHND_PMU_PMU2_PLL_PC1_M3DIV_MASK 	0x00ff0000
#define	BHND_PMU_PMU2_PLL_PC1_M3DIV_SHIFT	16
#define	BHND_PMU_PMU2_PLL_PC1_M4DIV_MASK 	0xff000000
#define	BHND_PMU_PMU2_PLL_PC1_M4DIV_SHIFT	24

/* m<x>div, ndiv_dither_mfb, ndiv_mode, ndiv_int */
#define	BHND_PMU_PMU2_PLL_PLLCTL2		2
#define	BHND_PMU_PMU2_PLL_PC2_M5DIV_MASK 	0x000000ff
#define	BHND_PMU_PMU2_PLL_PC2_M5DIV_SHIFT	0
#define	BHND_PMU_PMU2_PLL_PC2_M6DIV_MASK 	0x0000ff00
#define	BHND_PMU_PMU2_PLL_PC2_M6DIV_SHIFT	8
#define	BHND_PMU_PMU2_PLL_PC2_NDIV_MODE_MASK	0x000e0000
#define	BHND_PMU_PMU2_PLL_PC2_NDIV_MODE_SHIFT	17
#define	BHND_PMU_PMU2_PLL_PC2_NDIV_INT_MASK	0x1ff00000
#define	BHND_PMU_PMU2_PLL_PC2_NDIV_INT_SHIFT	20

/* ndiv_frac */
#define	BHND_PMU_PMU2_PLL_PLLCTL3		3
#define	BHND_PMU_PMU2_PLL_PC3_NDIV_FRAC_MASK	0x00ffffff
#define	BHND_PMU_PMU2_PLL_PC3_NDIV_FRAC_SHIFT	0

/* pll_ctrl */
#define	BHND_PMU_PMU2_PLL_PLLCTL4		4

/* pll_ctrl, vco_rng, clkdrive_ch<x> */
#define	BHND_PMU_PMU2_PLL_PLLCTL5			5
#define	BHND_PMU_PMU2_PLL_PC5_CLKDRIVE_CH1_MASK		0x00000f00
#define	BHND_PMU_PMU2_PLL_PC5_CLKDRIVE_CH1_SHIFT	8
#define	BHND_PMU_PMU2_PLL_PC5_CLKDRIVE_CH2_MASK		0x0000f000
#define	BHND_PMU_PMU2_PLL_PC5_CLKDRIVE_CH2_SHIFT	12
#define	BHND_PMU_PMU2_PLL_PC5_CLKDRIVE_CH3_MASK		0x000f0000
#define	BHND_PMU_PMU2_PLL_PC5_CLKDRIVE_CH3_SHIFT	16
#define	BHND_PMU_PMU2_PLL_PC5_CLKDRIVE_CH4_MASK		0x00f00000
#define	BHND_PMU_PMU2_PLL_PC5_CLKDRIVE_CH4_SHIFT	20
#define	BHND_PMU_PMU2_PLL_PC5_CLKDRIVE_CH5_MASK		0x0f000000
#define	BHND_PMU_PMU2_PLL_PC5_CLKDRIVE_CH5_SHIFT	24
#define	BHND_PMU_PMU2_PLL_PC5_CLKDRIVE_CH6_MASK		0xf0000000
#define	BHND_PMU_PMU2_PLL_PC5_CLKDRIVE_CH6_SHIFT	28

/* PMU rev 5 (& 6) */
#define	BHND_PMU_PMU5_PLL_P1P2_OFF		0
#define	BHND_PMU_PMU5_PLL_P1_MASK		0x0f000000
#define	BHND_PMU_PMU5_PLL_P1_SHIFT		24
#define	BHND_PMU_PMU5_PLL_P2_MASK		0x00f00000
#define	BHND_PMU_PMU5_PLL_P2_SHIFT		20
#define	BHND_PMU_PMU5_PLL_M14_OFF		1
#define	BHND_PMU_PMU5_PLL_MDIV_MASK		0x000000ff
#define	BHND_PMU_PMU5_PLL_MDIV_WIDTH		8
#define	BHND_PMU_PMU5_PLL_NM5_OFF		2
#define	BHND_PMU_PMU5_PLL_NDIV_MASK		0xfff00000
#define	BHND_PMU_PMU5_PLL_NDIV_SHIFT		20
#define	BHND_PMU_PMU5_PLL_NDIV_MODE_MASK	0x000e0000
#define	BHND_PMU_PMU5_PLL_NDIV_MODE_SHIFT	17
#define	BHND_PMU_PMU5_PLL_FMAB_OFF		3
#define	BHND_PMU_PMU5_PLL_MRAT_MASK		0xf0000000
#define	BHND_PMU_PMU5_PLL_MRAT_SHIFT		28
#define	BHND_PMU_PMU5_PLL_ABRAT_MASK		0x08000000
#define	BHND_PMU_PMU5_PLL_ABRAT_SHIFT		27
#define	BHND_PMU_PMU5_PLL_FDIV_MASK		0x07ffffff
#define	BHND_PMU_PMU5_PLL_PLLCTL_OFF		4
#define	BHND_PMU_PMU5_PLL_PCHI_OFF		5
#define	BHND_PMU_PMU5_PLL_PCHI_MASK		0x0000003f
...
#define	BHND_PMU_PMU5_MAINPLL_CPU		1
#define	BHND_PMU_PMU5_MAINPLL_MEM		2
#define	BHND_PMU_PMU5_MAINPLL_SI		3

#define	BHND_PMU_PMU7_PLL_PLLCTL7		7
#define	BHND_PMU_PMU7_PLL_PLLCTL8		8
#define	BHND_PMU_PMU7_PLL_PLLCTL11		11


/* PLL usage in 4716/47162 */
#define	BHND_PMU_PMU4716_MAINPLL_PLL0	12


/* PLL usage in 5356/5357 */
#define	BHND_PMU_PMU5356_MAINPLL_PLL0	0
#define	BHND_PMU_PMU5357_MAINPLL_PLL0	0
...
#define	BHND_PMU_PMU1_PLL0_CHIPCTL0		0
#define	BHND_PMU_PMU1_PLL0_CHIPCTL1		1
#define	BHND_PMU_PMU1_PLL0_CHIPCTL2		2
