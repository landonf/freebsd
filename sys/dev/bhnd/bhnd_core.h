...
#define	BHND_CF_PME_EN		0x4000		/**< enable power management events */
...
#define	BHND_SF_BIST_DONE	0x8000		/**< built-in self-test complete */
#define	BHND_SF_BIST_ERROR	0x4000		/**< built-in self-test error */
