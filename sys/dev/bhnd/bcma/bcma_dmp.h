...
/* Common definitions */
#define	BCMA_OOB_NUM_BANK	4	/**< number of OOB banks (A, B, C, D) */
...
#define	BCMA_OOB_PORTIN		0	/**< input selectors */
#define	BCMA_OOB_PORTOUT	1	/**< output selectors */
...
#define	BCMA_DMP_OOBSEL_N_MASK(_sel)	\
	(BCMA_DMP_OOBSEL_MASK << BCMA_DMP_OOBSEL_N_SHIFT(_sel))
#define	BCMA_DMP_OOBSEL_N_SHIFT(_sel)	((_sel % BCMA_OOB_NUM_SEL) * 8)

#define	BCMA_DMP_OOBSEL_GET(_value, _sel)	\
	(((_value) >> BCMA_DMP_OOBSEL_N_SHIFT(_sel)) & BCMA_DMP_OOBSEL_MASK)
#define	BCMA_DMP_OOBSEL_SET(_regval, _sel, _sval)		\
	(((_regval) & ~(BCMA_DMP_OOBSEL_N_MASK(_sel))) |	\
	 (((_sval) & BCMA_DMP_OOBSEL_MASK)) << BCMA_DMP_OOBSEL_N_SHIFT(_sel))

#define	BCMA_DMP_OOBSEL_0_MASK	BCMA_DMP_OOBSEL_N_MASK(0)
#define	BCMA_DMP_OOBSEL_1_MASK	BCMA_DMP_OOBSEL_N_MASK(1)
#define	BCMA_DMP_OOBSEL_2_MASK	BCMA_DMP_OOBSEL_N_MASK(2)
#define	BCMA_DMP_OOBSEL_3_MASK	BCMA_DMP_OOBSEL_N_MASK(3)

#define	BCMA_DMP_OOBSEL_4_MASK	BCMA_DMP_OOBSEL_N_MASK(4)
#define	BCMA_DMP_OOBSEL_5_MASK	BCMA_DMP_OOBSEL_N_MASK(5)
#define	BCMA_DMP_OOBSEL_6_MASK	BCMA_DMP_OOBSEL_N_MASK(6)
#define	BCMA_DMP_OOBSEL_7_MASK	BCMA_DMP_OOBSEL_N_MASK(7)

#define	BCMA_DMP_OOBSEL_0_SHIFT	BCMA_DMP_OOBSEL_N_SHIFT(0)
#define	BCMA_DMP_OOBSEL_1_SHIFT	BCMA_DMP_OOBSEL_N_SHIFT(1)
#define	BCMA_DMP_OOBSEL_2_SHIFT	BCMA_DMP_OOBSEL_N_SHIFT(2)
#define	BCMA_DMP_OOBSEL_3_SHIFT	BCMA_DMP_OOBSEL_N_SHIFT(3)

#define	BCMA_DMP_OOBSEL_4_SHIFT	BCMA_DMP_OOBSEL_N_SHIFT(4)
#define	BCMA_DMP_OOBSEL_5_SHIFT	BCMA_DMP_OOBSEL_N_SHIFT(5)
#define	BCMA_DMP_OOBSEL_6_SHIFT	BCMA_DMP_OOBSEL_N_SHIFT(6)
#define	BCMA_DMP_OOBSEL_7_SHIFT	BCMA_DMP_OOBSEL_N_SHIFT(7)
