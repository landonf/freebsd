...
/* sbipsflag */
#define	SIBA_IPS_INT_COUNT	4		/* number of sbflags mapped via sbipsflag */
#define	SIBA_IPS_INT_MASK	0x3f
#define	SIBA_IPS_INT_SHIFT(_n)	(((_n)-1) * 8)

#define	SIBA_IPS_INT1_MASK	0x3f		/* which sbflags get routed to mips interrupt 1 */
#define	SIBA_IPS_INT1_SHIFT	SIBA_IPS_INT_SHIFT(1)
#define	SIBA_IPS_INT2_MASK	0x3f00		/* which sbflags get routed to mips interrupt 2 */
#define	SIBA_IPS_INT2_SHIFT	SIBA_IPS_INT_SHIFT(2)
#define	SIBA_IPS_INT3_MASK	0x3f0000	/* which sbflags get routed to mips interrupt 3 */
#define	SIBA_IPS_INT3_SHIFT	SIBA_IPS_INT_SHIFT(3)
#define	SIBA_IPS_INT4_MASK	0x3f000000	/* which sbflags get routed to mips interrupt 4 */
#define	SIBA_IPS_INT4_SHIFT	SIBA_IPS_INT_SHIFT(4)
